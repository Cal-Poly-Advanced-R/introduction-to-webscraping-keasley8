...
### Fetching Cheeses with Name
```{r}
#| label: fetching-cheeses-with-name
...
# Why is cheese name repeated many times in cheese type
cheeses_top10 <- all_cheeses |>
  slice_head(n = 10)

cheese_info <- map(cheeses_top10$URL, get_cheese_info_url) |>
  bind_rows()
